...
const EditOnline = ({profileButton}) => {
  ...
  const updateAllForPublish = () => {
    ...
    setPublishData((pre)=>{ console.log("PublishData: ", {...pre, onlineCard_Data:newOnlineCardData}); return {...pre, onlineCard_Data:newOnlineCardData}});
  ...
  return (
    <div className="editOnline" style={{ backgroundColor:backgroundColor, backgroundImage:backgroundImage!=='' ? `url(${backgroundImage})`:"", backgroundSize:"cover" }}>
