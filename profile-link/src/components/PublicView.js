  ...
  return (
    <div className=''>
      ...
      <div className="min-w-[320px] w-[50%] mx-auto pt-1">
        ...
        {/* <DraggableForm /> */}
        <div style={{ display: 'flex', flexDirection: 'column', backgroundColor:publishData.bgColor, backgroundImage:publishData.bgURL!=='' ? `url(${publishData.bgURL})`:"", backgroundSize:"cover" }} className='rounded-md shadow-lg p-4 mb-[30px]'>
