...
import { noContactList, deletedList, blockList, profileButton, pendingList, acceptedList } from "./data.js";
/**
        ...
        <Routes>
          ...
          <Route path="/layout" element={<Layout contact_badge = {4} chat_badge = {8}/>} >
            <Route path="list" >
              ...
              <Route path="nocontactlist" element={<NocontactList noContactList={noContactList} />} />
              <Route path="deletedlist" element={<DeletedList deletedList={deletedList} />} />
              <Route path="blocklist" element={<BlockList blockList={blockList} />} />
            </Route>
          </Route>
